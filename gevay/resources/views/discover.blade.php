...
<link rel="stylesheet" type="text/css" href="{{url('')}}/public/css/bootstrap-datetimepicker.css">
@stop
            ...
            <div class="panel panel-default">
                <div id="conver" class="panel-body profile" style="background-size: 100% 100%;">
                    <div class="profile-image">
                        <img src="https://graph.facebook.com/{{$pageid}}/picture?"  class="img-circle" alt="Nadia Ali"/>
                    </div>
                            ...
                            <select id="select01" class="form-control col-md-6">
                                ...
                                foreach ($fan as $value) {
                                  if($value->isdef==0)
                                  {
                                      $i++;
                                      ?>
                                      <option name="{{$value->pagetoken}}" value="{{$value->pageid}}">{{$i}} - {{$value->pagename}}</option>
