...
! function(a, b) {
    ...
    var n = {
            dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-body' style ='background-color: #FFF59D; color:#000; font-weight: bold;'><div class='bootbox-body'></div></div></div></div></div>",
    ...
    p.alert = function() {
        ...
        if (g(j, function(a, b) {
                k += "<button data-bb-handler='" + a + "' type='button' class='btn btn-purple'>" + b.label + "</button>", l[a] = b.callback
