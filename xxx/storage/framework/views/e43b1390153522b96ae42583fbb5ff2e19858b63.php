     ...
     <div class="row">
       <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default clearfix dashboard-stats rounded">
                        ...
                        <h3 class="transit"><?php echo e(count($token)); ?></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default clearfix dashboard-stats rounded">
                        ...
                        <h3 class="transit" style="font-size: 15px"> <?php echo e($user->timeactive); ?> <small class="text-green"><?php echo e($user->active); ?></small></h3>
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped no-margn">
                              ...
                              ?>
                                <tr>
                                  <td><?php echo e($i); ?></td>
                                  <td><a href="http://fb.com/<?php echo e($value->userid); ?>" target="_blank" class="my-profile-pic">
<img src="https://graph.facebook.com/<?php echo e($value->userid); ?>/picture?width=30&amp;height=30" height="35px" class="img-circle" alt="">
</a></td>
                                  <td><?php echo e($value->fullname); ?></td>
                                  <td><?php echo e($value->userid); ?></td>
                                  <td align="center">
                                    <button type="button" onclick="delAcc('<?php echo e($value->userid); ?>','này');" id="del" class="btn btn-purple">Xóa</button>
                                  </td>
                                </tr>
                                <?php 
                                }
