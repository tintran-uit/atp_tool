...
<div class="container">
        ...
        <div class="col-lg-5 panel panel-default custom-center">
            ...
            <hr class="clean">
            <form class="form-horizontal" name="register" onsubmit="return validateForm()" style="padding: 20px 55px" role="form" method="POST" action="{{ url('/register') }}" role="form">
                        {!! csrf_field() !!}
               ...
               <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Tên của bạn">
                                  </div>
                                @if ($errors->has('name'))
