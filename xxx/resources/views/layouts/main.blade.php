...
<head>
    ...
    <link href="{{url('')}}/public/fonts/css/font-awesome.min.css" rel="stylesheet">
     ...
     <link rel="stylesheet" type="text/css" href="{{url('')}}/public/assets/css/toast-t/toastr.custom.css">
    <link rel="stylesheet" type="text/css" href="{{url('')}}/public/assets/css/toast-t/toastr-responsive.css">
    ...
    <link rel="stylesheet" href="{{url('')}}/public/assets/css/slider-t/style.css">
    

    <script src="{{url('')}}/public/js/jquery.min.js"></script>

    <link href="{{url('')}}/public/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{url('')}}/public/assets/css/date-t/datepicker.css">

 <!-- Custom styling plus plugins -->
    <link href="{{url('')}}/public/css/custom.css" rel="stylesheet">
    <!-- custom css  -->
    <link rel="stylesheet" href="{{url('')}}/public/assets/css/app/app.v1.css" />
     <link rel="stylesheet" type="text/css" href="{{url('')}}/public/assets/css/toast-t/jquery.jgrowl.css">
</head>
<body class="nav-md">
@yield('load')
        ...
        <div class="main_container">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <a href="{{url('/quan-ly-tai-khoan')}}" class="site_title"><i class="fa fa-flag-o"></i><b>ATP</b> <span style="font-size: 13px; margin-left: 8px; color: #00897B;letter-spacing: 3px;"> RIPv2</span></a>
                    </div>
                            ...
                            <ul class="nav side-menu">
                                <li class=" "><a><i class="fa fa-user"></i> Tài khoản <span class="label label-success">3</span><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="{{url('/access-token')}}">Access Token</a></li>
                                        <li data-toggle="modal" data-target="#myModal"><a >Thay đổi mật khẩu</a></li>
                                        
                                    </ul>
                                </li>
                                <li class=""><a href="{{url('/gui-tin-nhan')}}"><i class="fa fa-comment-o"></i> Gửi tin nhắn<span class="fa fa-chevron-circle-right"></span></a>
                       
                                </li>
                                <li><a><i class="fa fa-file-text-o"></i>Đăng bài <span class="label label-success">2</span><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                       <li><a href="{{url('dang-bai-len-nhom')}}">Đăng bài lên nhóm</a></li>
                            
                                    <li><a href="{{url('dang-bai-len-tuong')}}">Đăng bài lên tường</a></li>
                                    </ul>
                                </li>
                                <li class=""><a href="{{url('/up-top-bai-viet')}}"><i class="fa fa-flag-o"></i> Úp top bài viết<span class="fa fa-chevron-circle-right"></span></a>
                       
                                </li>
                                <li><a><i class="fa fa-wrench"></i> Công cụ <span class="label label-success">8</span><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="{{url('/yeu-cau-ket-ban')}}">Gửi yêu cầu kêt bạn</a></li>
                                        <li><a href="{{url('/moi-thich-trang')}}">Mời bạn bè thích trang</a></li>
                                        <li><a href="{{url('/moi-su-kien')}}">Mời bạn bè vào sự kiện</a></li>
                                        <li><a href="{{url('/huy-ket-ban')}}">Hủy kết bạn</a></li>
                                        <li><a href="{{url('/tham-gia-nhom')}}">Tham gia nhóm</a></li>
                                        <li><a href="{{url('/them-ban-vao-nhom')}}">Thêm bạn vào nhóm</a></li>
                                        <li><a href="{{url('/keo-nhom')}}">Kéo nhóm</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-edit"></i>Thanh toán <span class="label label-success">1</span><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                       <li><a href="{{url('tai-khoan-ngan-hang')}}">Tài khoản ngân hàng</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="width: 500px; margin-left: 100px;">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/change-pass') }}" role="form">
...
<div id="modalCheckPhone" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form name="checkPhone"  onsubmit="return validateFormCheckPhone()"  method="POST" action="{{ url('/check-phone') }}">
                    {!! csrf_field() !!}
 ...
 <!-- Content Block Ends Here (right box)-->
    ...
    <!-- toast -->
    <script src="{{url('')}}/public/assets/js/toast-t/toastr.min.js"></script>
    <script src="{{url('')}}/public/assets/js/toast-t/jquery.jgrowl.min.js"></script>
   
    
 <script src="{{url('')}}\public\assets\js\table\dataTables.min.js"></script>
 <script src="{{url('')}}\public\assets\js\table\dataTables.bootstrap.min.js"></script>
    
<script type="text/javascript" src="{{url('')}}/public/assets/js/xl.js"></script>
<script type="text/javascript" src="{{url('')}}/public/assets/js/txt.js"></script>
<script type="text/javascript" src="{{url('')}}/js/include/bootbox.min.js"></script>
...
<script src="{{url('')}}/public/assets/js/toast-t/toast-slider.js"></script>
 <script src="{{url('')}}/public/js/custom.js"></script>
<script type="text/javascript" src="{{url('')}}/public/assets/js/bootstrap-progressbar.min.js"></script>
</body>
