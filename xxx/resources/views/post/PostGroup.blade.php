            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">Đăng bài lên nhóm</div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="input-group margin-bottom-sm">
                                              ...
                                              <input class="form-control" id="url" type="text" placeholder="Nhập Link chia sẻ" id="input02">
                                            </div>
                                    </div>
                                </div>
                                <hr/>
                          ...
                          <fieldset class="form-horizontal themed" id="uislider-demo">
                                            ...
                                            <div class="control-group">
                                              <hr/>
                                                ...
                                                <div class="controls">
                                                    <p class="info-block col-md-5">Phạm vi:
