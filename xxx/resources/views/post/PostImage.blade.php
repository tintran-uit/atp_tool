            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">Đăng hình lên nhóm</div>
                            <div class="panel-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <select id="select01" onchange="getAcc(1);" class="form-control col-md-6">
                                    <option value="0"><b>Tài khoản</b></option>
                                        <?php 
                                          ...
                                          $i++;
                                          ?>
                                        <option name="{{$value->userid}}" value="{{$value->access_token}}">{{$i}} - {{$value->fullname}}</option>
                                ...
                                <div class="control-group col-md-offset-1">
                                    ...
                                    <div class="controls">
                                        <form id="uploadimage" action="" method="post" enctype="multipart/form-data">
                                            <div id="selectImage">
                                                <input class="btn btn-purple" type="file" name="file" id="file"  required=""/>
                                                </div>
                                        </form>
                                         <form id="uploadimage" action="" method="post" enctype="multipart/form-data">
                                         <br/>
                                            <div id="image_preview">
                                              <h4 id='loading'>
                                              <img id="previewing" src="{{url('')}}/public/images/noimage.png" height="250">
                                              </h4>
                                              <input id="url" type="hidden">
                                              <input id="img" value="{{url('')}}/public/images/noimage.png" type="hidden">
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
@section('script')
 <script type="text/javascript" src="{{url('')}}/public/assets/js/img.js"></script>
@stop
