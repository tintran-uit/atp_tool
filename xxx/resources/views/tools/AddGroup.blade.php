            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">Tham gia nhóm</div>
                                                ...
                                                <div class="input-group">
                                                        <input id="ididid" type="text form-control" class="form-control">
                                                          <span class="input-group-btn">
                                                               <div class="btn-group">
                                                                <button onclick="requestSearch();" class="btn btn-purple" data-toggle="dropdown">Tìm kiếm <span class="glyphicon glyphicon-search"></span></button>
                    ...
                    <div class="inner-spacer">
                      ...
                      <div class="panel-body custom-padding">
                          ...
                          <div class="btn-group custom-margin" style="float: right; margin: 20px 0px; height: 100%">
                            ...
                            <button type="button" onclick="myRun(4);" class="btn btn-primary">Tham gia nhóm</button>
