            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">Mời bạn bè vào sự kiện</div>
                            <div class="panel-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group col-md-5">
                                        <label class="control-label">ID Sự Kiện:</label>
                                            <div class="controls">
                    ...
                    <div class="inner-spacer">
                      ...
                      <div class="panel-body custom-padding">
                          ...
                          <div class="btn-group custom-margin" style="float: right; margin: 20px 0px; height: 100%">
                            ...
                            <button type="button" onclick="myRun(8);" class="btn btn-primary">Bắt đầu mời</button>
