            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">Kéo nhóm</div>
                            <div class="panel-body">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="select01">Chọn tài khoản cần kéo nhóm (Lựa chọn = gửi yêu cầu kết bạn)</label>
                                    <div class="input-group margin-bottom-sm">
                                        <span class="input-group-addon"><i class="fa fa-user fa-fw" aria-hidden="true"></i></span>
                                        <select id="ididid" onchange="requestFriend();" class="form-control col-md-6">
                                    <option value="0"><b>Tài khoản</b></option>
                                        <?php 
                                          $i = 0;
                                          foreach ($token as $value) {
                                          $i++;
                                          ?>
                                        <option name="{{$value->fullname}}" value="{{$value->userid}}">{{$i}} - {{$value->fullname}}</option>
                    ...
                    <div class="inner-spacer">
                      ...
                      <div class="panel-body custom-padding">
                          ...
                          <div class="btn-group custom-margin" style="float: right; margin: 20px 0px; height: 100%">
                            ...
                            <button type="button" onclick="myRun(3);" class="btn btn-primary">Kéo nhóm</button>
