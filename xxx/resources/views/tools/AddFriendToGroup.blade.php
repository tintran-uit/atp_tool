            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">Thêm bạn vào nhóm</div>
                            <div class="panel-body">
                                ...
                                <hr/>
                                    <div class="control-group">
                                      <div class="col-md-5">
                                        <label class="control-label">UID nhóm cần thêm:</label>
                                              <div class="controls">
                    ...
                    <div class="inner-spacer">
                      ...
                      <div class="panel-body custom-padding">
                          ...
                          <div class="btn-group custom-margin" style="float: right; margin: 20px 0px; height: 100%">
                            ...
                            <button type="button" onclick="myRun(7);" class="btn btn-primary">Bắt đầu kéo nhóm</button>
